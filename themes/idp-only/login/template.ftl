...
<#macro registrationLayout bodyClass="" displayInfo=false displayMessage=true displayRequiredFields=false>
    ...
    <head>
        ...
        <script type="module">
            import { startSessionPolling } from "themes/idp-only/login${url.resourcesPath}/js/authChecker.js";
        ...
        <#if authenticationSession??>
            <script type="module">
                import { checkAuthSession } from "themes/idp-only/login${url.resourcesPath}/js/authChecker.js";
